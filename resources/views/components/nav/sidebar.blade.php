<div
    ...
    <a class="flex items-center transition-[margin] duration-300 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-0 group-[.side-menu--collapsed]:xl:ml-4"
      ...
      <div class="transition-transform ease-in-out group-[.side-menu--collapsed.side-menu--on-hover]:xl:-rotate-360">
        <div class="relative h-[50px] w-[50px] [&_div]:bg-white">
          <img src="{{ asset('resources/icon/turbo.png') }}" alt="TURBO" style="position: relative; left: -10px;">
        </div>
      </div>
  ...
  <div
    ...
    <ul class="scrollable">
      ...
      <x-nav.nav-link href="{{ route('/') }}" :active="request()->is('/')" icon="gauge-circle">Dashboard</x-nav.nav-link>
      <li>
        <a href="hook-dashboard-overview-2.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-dashboard-overview-3.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-dashboard-overview-4.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-dashboard-overview-5.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-dashboard-overview-6.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-dashboard-overview-7.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-dashboard-overview-8.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-inbox.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-file-manager-list.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-file-manager-grid.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-point-of-sale.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-chat.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-calendar.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-creative.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="album" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-dynamic.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="activity-square" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-interactive.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-users.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-departments.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-add-user.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-profile-overview.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-profile-overview-events.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="calendar-range" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-profile-overview-achievements.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-profile-overview-contacts.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-profile-overview-default.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-email-settings.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-security.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-preferences.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-two-factor-authentication.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-device-history.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="keyboard" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-settings-notification-settings.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-connected-services.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-social-media-links.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-settings-account-deactivation.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-billing.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-invoice.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-categories.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="book-marked" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-add-product.html" class="side-menu__link ">
      ...
      <li>
        ...
        <ul class="hidden">
          <li>
            <a href="hook-product-list.html" class="side-menu__link ">
          ...
          <li>
            <a href="hook-product-grid.html" class="side-menu__link ">
      ...
      <li>
        ...
        <ul class="hidden">
          <li>
            <a href="hook-transaction-list.html" class="side-menu__link ">
          ...
          <li>
            <a href="hook-transaction-detail.html" class="side-menu__link ">
      ...
      <li>
        ...
        <ul class="hidden">
          <li>
            <a href="hook-seller-list.html" class="side-menu__link ">
          ...
          <li>
            <a href="hook-seller-detail.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-reviews.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-login.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-register.html" class="side-menu__link ">
      ...
      <li>
        ...
        <ul class="hidden">
          <li>
            <a href="hook-regular-table.html" class="side-menu__link ">
          ...
          <li>
            <a href="hook-tabulator.html" class="side-menu__link ">
      ...
      <li>
        ...
        <ul class="hidden">
          <li>
            <a href="hook-modal.html" class="side-menu__link ">
          ...
          <li>
            <a href="hook-slideover.html" class="side-menu__link ">
          ...
          <li>
            <a href="hook-notification.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-tab.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-accordion.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-button.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="plus-square" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-alert.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="presentation" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-progress-bar.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-tooltip.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-dropdown.html" class="side-menu__link ">
          <i data-tw-merge="" data-lucide="flip-vertical" class="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
      ...
      <li>
        <a href="hook-typography.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-icon.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-loading-icon.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-regular-form.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-datepicker.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-tom-select.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-file-upload.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-wysiwyg-editor.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-validation.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-chart.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-slider.html" class="side-menu__link ">
      ...
      <li>
        <a href="hook-image-zoom.html" class="side-menu__link ">
